...
function pull_or_clone_proj() {
 ...
 #  git branch -f master origin/master
   git checkout hometask-2
   git pull
   cd ..
  else
    git clone --branch hometask-2 ${SERVICE_URL} ${SERVICE_NAME}
 fi
}
...
pull_or_clone_proj common-module https://github.com/VerstakovaPolina/common-module.git
pull_or_clone_proj medical-monitoring https://github.com/VerstakovaPolina/medical-monitoring.git
pull_or_clone_proj message-analyzer https://github.com/VerstakovaPolina/message-analyzer.git
pull_or_clone_proj person-service https://github.com/VerstakovaPolina/person-service.git
